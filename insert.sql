...
-- Customer rows (vendors are also customers)
...
-- Vendor profile rows (bio/portfolio)
INSERT INTO Vendor (userID, bio, portfolio) VALUES
(@vendor1, 'Nature photographer',         'https://portfolio.example/viv'),
(@vendor2, 'City & abstract visual artist','https://portfolio.example/val');
...
-- IMAGES (15 items) owned by Vendors
SET
...
-- RATINGS (by customers/vendors since both exist in Customer)
